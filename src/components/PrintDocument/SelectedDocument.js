...
const Resume = (props) => (
  <Page {...props} style={styles.page}>
    ...
    //       <Image
    //         src={product.productImages ? `${BASE_URL}${product.productImages[0].split('\\')[1]}` : ''}
    //         style={styles.image}
    //       />
    //       <Image
    //         src={`https://api.qrserver.com/v1/create-qr-code/?data=${product._id}&amp;size=100x100`}
...
function SelectedDocument({ data }) {
  return (
    <Document
