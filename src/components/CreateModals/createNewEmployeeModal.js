...
import { ADMIN, AVAILABLE_STORES_URL, BANK_AGENT, STORE_EMPLOYEE, STORE_MANAGER, USERS_URL } from '../../Constants';
export const CreateNewEmployeeModal = ({ open, columns, onClose, onSubmitModal }) => {
  const api = useAxios();
